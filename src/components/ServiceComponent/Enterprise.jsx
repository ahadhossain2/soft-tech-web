    ...
    <>
      ...
      <div className="w-full hero-bg py-24 px-4 md:px-12" ref={heroRef}>
        <div className="max-w-8xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            "
            >
              As your enterprise continually grows and evolves, so do your
              software development needs. With our scalable and robust
              enterprise software development services, we ensure your business
      ...
      >
        <motion.p
          ...
          exit={{ opacity: 0, y: -50 }}
          transition={{ duration: 0.8 }}
          className="text-sm sm:text-base md:text-lg font-extrabold text-[#151517] text-center sm:text-left leading-relaxed max-w-full sm:max-w-xl md:max-w-2xl mx-auto sm:mx-0"
        >
          In the modern age, robust enterprise software development services
          aren’t just good to have, they are vital to stay competitive. Here’s
          what you can expect from our software development team:
        </motion.p>
        <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2">
          {services.map(({ title, description }, i) => (
            <motion.article
              variants={enterprisecardVariants}
              initial="hidden"
      ...
      >
        <header className="mb-6">
          ...
          >
            Enterprise software development is in constant flux, so staying up
            to date with the latest methods is essential. At SoftTech, we follow
            these best practices to ensure that your website stays efficient and
            user-friendly.
          </motion.p>
        </header>
