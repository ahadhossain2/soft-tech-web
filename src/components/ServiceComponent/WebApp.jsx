    ...
    <>
      ...
      <div className="w-full hero-bg py-24 px-4 md:px-12" ref={heroRef}>
        <div className="max-w-8xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            "
            >
              Your one-stop shop for stellar web applications, built with the
              latest technologies to create the value that you and your users
              are looking for.
            </motion.p>
            <motion.a
      ...
      >
        ...
        >
          ...
          market trends, and regulations, we make sure you don’t have to go
          anywhere else for your web application development needs. Our web
          application development team creates high-quality, user-friendly
          websites and web applications that meet the unique needs of your
          business, whether it’s a startup or a conglomerate.
        </motion.p>
